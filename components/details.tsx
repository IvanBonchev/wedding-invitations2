...
export function Details() {
  ...
  Квіти швидко в’януть, а гарні спогади залишаються! Замість букетів просимо дарувати пляшку алкоголю 
  для нашої домашньої колекції — обіцяємо відкрити її під час наступного теплого приводу.
</p>

<p className="mt-4 text-pretty text-lg leading-relaxed text-ink">
  Важливо для гостей із дітьми: будь ласка, напишіть нам, якщо будете з малечею, аби ми організували для них 
  комфортний дитячий стіл та розваги.
</p>
